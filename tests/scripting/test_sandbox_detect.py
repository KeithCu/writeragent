...
"""Tests for Flatpak / Snap sandbox detection and command wrapping."""
...
from plugin.scripting.sandbox_detect import detect_sandbox, wrap_command_for_sandbox, _reset_cache
...
class DetectSandboxTests(unittest.TestCase):
    ...
    @patch("plugin.scripting.sandbox_detect.os.path.exists", return_value=True)
    ...
    @patch("plugin.scripting.sandbox_detect.os.path.exists", return_value=False)
