...
**smolagents [`agents.py`](plugin/contrib/smolagents/agents.py)** — Vendored fork ships only `MultiStepAgent` and `ToolCallingAgent` (no `CodeAgent`, Hugging Face Hub save/load, or related helpers).
