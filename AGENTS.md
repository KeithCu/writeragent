...
- **Grammar proofreader:** [`plugin/writer/locale/ai_grammar_proofreader.py`](plugin/writer/locale/ai_grammar_proofreader.py), [`grammar_proofread_text.py`](plugin/writer/locale/grammar_proofread_text.py) (split, JSON, offsets, sentence scheduling), [`grammar_proofread_cache.py`](plugin/writer/locale/grammar_proofread_cache.py), [`grammar_proofread_work_item.py`](plugin/writer/locale/grammar_proofread_work_item.py), [`grammar_work_queue.py`](plugin/writer/locale/grammar_work_queue.py) (LLM worker + queue), [`grammar_queue_state.py`](plugin/writer/locale/grammar_queue_state.py) (pure enqueue supersede / stale helpers); [`grammar_proofread_engine.py`](plugin/writer/locale/grammar_proofread_engine.py) re-exports **`GRAMMAR_REGISTRY_LOCALE_TAGS`** only (compat shim). Service **`__init__(self, ctx, *args)`** required—LibreOffice uses `createInstanceWithArgumentsAndContext`. Keep top-level imports minimal. XCU/locale parity: [`grammar_locale_registry.py`](plugin/writer/locale/grammar_locale_registry.py), [`plugin/tests/writer/locale/test_grammar_linguistic_xcu.py`](plugin/tests/writer/locale/test_grammar_linguistic_xcu.py). Queue/cache semantics: [`docs/realtime-grammar-checker-plan.md`](docs/realtime-grammar-checker-plan.md).
