...
| PPT-Master (Impress/Draw sidebar) | Adapter code [`plugin/contrib/ppt_master/`](plugin/contrib/ppt_master/); upstream via user venv; UNO in [`plugin/ppt_master/`](plugin/ppt_master/); session [`plugin/chatbot/ppt_master.py`](plugin/chatbot/ppt_master.py) — [docs/ppt-master-integration-plan.md](docs/ppt-master-integration-plan.md) |
...
| PPT-Master (Impress/Draw) | [docs/ppt-master-integration-plan.md](docs/ppt-master-integration-plan.md) — adapters [`plugin/contrib/ppt_master/`](plugin/contrib/ppt_master/); upstream from user venv |
