...
- **Grammar proofreader:** [`plugin/writer/locale/ai_grammar_proofreader.py`](plugin/writer/locale/ai_grammar_proofreader.py), [`plugin/writer/locale/grammar_proofread_engine.py`](plugin/writer/locale/grammar_proofread_engine.py). Service **`__init__(self, ctx, *args)`** required—LibreOffice uses `createInstanceWithArgumentsAndContext`. Keep top-level imports minimal. XCU/locale parity: [`grammar_locale_registry.py`](plugin/writer/locale/grammar_locale_registry.py), [`plugin/tests/writer/locale/test_grammar_linguistic_xcu.py`](plugin/tests/writer/locale/test_grammar_linguistic_xcu.py). Queue/cache semantics: [`docs/realtime-grammar-checker-plan.md`](docs/realtime-grammar-checker-plan.md).
