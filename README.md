...
- **Enable it**: Set path in **Settings → Python**. Exposed to LLMs in Writer, Calc, and Draw / Impress (`run_venv_python_script`, `=PYTHON()`, and Calc **Analysis Helpers** in **Run Python Script…**).
