...
*   **Sidebar**: When an external backend is selected, a small label in the chat panel (e.g. “Aider” or “Hermes”) shows which backend is active. The LLM model selector, Image generation, and Web research tools are automatically disabled to prevent conflicts. Send and Stop behave as usual.
