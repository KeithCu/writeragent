...
The Collabora **Python Compute Service** is a different product: kit JSON is forwarded as raw `data` / `result_json` bytes (see [`compute_service/README.md`](../../compute_service/README.md)). Do not fold that HTTP path into this desktop codec.
