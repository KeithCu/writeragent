...
**Shared:** [`LlmClient`](../plugin/networking/client.py) only—no duplicate strip/shim/parser logic in smol-specific files.
...
| HTTP client | [`plugin/networking/client.py`](../plugin/networking/client.py) |
