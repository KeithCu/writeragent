...
- Unit (work queue dedup): [`plugin/tests/test_grammar_work_queue.py`](../plugin/tests/test_grammar_work_queue.py) — prefix dedup, supersede, mixed dedup, cross-locale independence, sentence splitter, trailing whitespace normalization, per-sentence cache roundtrip.
