...
- **Engine (testable)**: [`plugin/writer/locale/grammar_proofread_engine.py`](../plugin/writer/locale/grammar_proofread_engine.py) re-exports [`grammar_proofread_text.py`](../plugin/writer/locale/grammar_proofread_text.py) (BreakIterator, sentence splitting, LLM JSON parse, offset normalization), [`grammar_proofread_cache.py`](../plugin/writer/locale/grammar_proofread_cache.py), [`grammar_proofread_work_item.py`](../plugin/writer/locale/grammar_proofread_work_item.py) (batch dedup), and [`grammar_queue_state.py`](../plugin/writer/locale/grammar_queue_state.py) (pure enqueue supersede / stale helpers used by [`ai_grammar_proofreader.py`](../plugin/writer/locale/ai_grammar_proofreader.py) `_GrammarWorkQueue`).
