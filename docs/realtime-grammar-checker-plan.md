...
**Regression test:** [`test_two_sentences_string_prefix_collision_both_survive`](../plugin/tests/writer/locale/test_grammar_work_queue.py). Implementation notes are in **comments directly above** [`deduplicate_grammar_batch`](../plugin/writer/locale/grammar_proofread_work_item.py) in that file (re-exported from [`grammar_proofread_engine.py`](../plugin/writer/locale/grammar_proofread_engine.py); not in the module docstring).
...
- **Engine (testable)**: [`plugin/writer/locale/grammar_proofread_engine.py`](../plugin/writer/locale/grammar_proofread_engine.py) re-exports [`grammar_proofread_text.py`](../plugin/writer/locale/grammar_proofread_text.py) (BreakIterator, sentence splitting, LLM JSON parse, offset normalization), [`grammar_proofread_cache.py`](../plugin/writer/locale/grammar_proofread_cache.py) (sentence LRU; **authoritative** Unicode sentence-terminal / trailing-closer sets and `looks_complete_sentence` shared with [`ai_grammar_proofreader.py`](../plugin/writer/locale/ai_grammar_proofreader.py)), [`grammar_proofread_work_item.py`](../plugin/writer/locale/grammar_proofread_work_item.py) (batch dedup), and [`grammar_queue_state.py`](../plugin/writer/locale/grammar_queue_state.py) (pure enqueue supersede / stale helpers used by `_GrammarWorkQueue`).
