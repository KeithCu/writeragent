...
class CreateShape(ToolBase):
    ...
    parameters = {
        ...
        "properties": {
            "shape_type": {
                "type": "string",
                "description": "Type of shape. Simple names: rectangle, ellipse, text, line, connector. Or CustomShape types: bang, block-arc, brace-pair, bracket-pair, can, chevron, circular-arrow, cloud-callout, cross, cube, diamond, down-arrow, down-arrow-callout, ellipse, flowchart-alternate-process, flowchart-card, flowchart-collate, flowchart-connector, flowchart-data, flowchart-decision, flowchart-delay, flowchart-direct-access-storage, flowchart-display, flowchart-document, flowchart-extract, flowchart-internal-storage, flowchart-magnetic-disk, flowchart-manual-input, flowchart-manual-operation, flowchart-merge, flowchart-multidocument, flowchart-off-page-connector, flowchart-or, flowchart-predefined-process, flowchart-preparation, flowchart-process, flowchart-punched-tape, flowchart-sequential-access, flowchart-sort, flowchart-stored-data, flowchart-summing-junction, flowchart-terminator, fontwork-*, forbidden, frame, heart, hexagon, horizontal-scroll, isosceles-triangle, left-arrow, left-arrow-callout, left-brace, left-bracket, left-right-arrow, left-right-arrow-callout, lightning, line-callout-1, line-callout-2, line-callout-3, moon, non-primitive, notched-right-arrow, octagon, ooxml-rect, paper, parallelogram, pentagon, pentagon-right, quad-arrow, quad-arrow-callout, quad-bevel, rectangle, rectangular-callout, right-arrow, right-arrow-callout, right-brace, right-bracket, right-triangle, ring, round-callout, round-rectangle, round-rectangular-callout, sinusoid, smiley, star24, star4, star5, star8, striped-right-arrow, sun, teardrop, trapezoid, up-arrow, up-arrow-callout, up-down-arrow, up-down-arrow-callout, vertical-scroll.",
            },
