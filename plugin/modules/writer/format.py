...
from plugin.modules.doc.document_helpers import normalize_linebreaks as _normalize
...
from plugin.modules.writer.ops import get_selection_range, get_text_cursor_at_range
