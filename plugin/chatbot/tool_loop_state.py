...
_DEAL_TRUNCATE_TASK_LEN = 4 if UNDER_CROSSHAIR else DEAL_MAX_SOURCE
_DEAL_TRUNCATE_MAX_LEN = 4 if UNDER_CROSSHAIR else DELEGATE_TASK_CHAT_MAX
# cover-all 33180040863: describe_empty / domain_from_delegate still multi-10m at TOKEN=16.
# 33211730747: tool_loop_state ~56m — shrink keys/dicts further.
_DEAL_EMPTY_TC_LEN = 1 if UNDER_CROSSHAIR else DEAL_MAX_CMD_ARGS
_DEAL_EMPTY_TOKEN_LEN = 2 if UNDER_CROSSHAIR else DEAL_MAX_TOKEN
_DEAL_FUNC_ARG_TOKEN_LEN = 2 if UNDER_CROSSHAIR else DEAL_MAX_TOKEN
