...
class TestFetchAvailableModelsCache(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        keys_to_del = [
            k
            for k in cfg._model_fetch_cache
            if "127.0.0.1:58901" in k
            or "127.0.0.1:58902" in k
            or "127.0.0.1:58903" in k
            or "127.0.0.1:58904" in k
            or "127.0.0.1:58905" in k
        ]
