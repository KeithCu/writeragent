...
from plugin.modules.writer.specialized_base import ToolWriterSpecialBase, SpecializedWorkflowFinished
from plugin.modules.writer.specialized_base import DelegateToSpecializedWriter
...
@patch(
    "plugin.modules.chatbot.smol_agent.get_config_int",
    side_effect=_mock_get_config_int_for_sub_agent,
)
@patch("plugin.modules.chatbot.smol_agent.get_api_config", create=True)
@patch("plugin.modules.chatbot.smol_agent.ToolCallingAgent")
@patch("plugin.modules.chatbot.smol_agent.WriterAgentSmolModel")
@patch("plugin.modules.chatbot.smol_agent.LlmClient")
