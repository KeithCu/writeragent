...
from plugin.modules.chatbot.smol_agent import build_toolcalling_agent, SmolToolAdapter, to_smol_inputs
...
@patch("plugin.modules.chatbot.smol_agent.get_config_int")
@patch("plugin.modules.chatbot.smol_agent.get_api_config")
