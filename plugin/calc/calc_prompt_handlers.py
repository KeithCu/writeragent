...
from plugin.framework.config import get_api_config, get_config, get_config_int
...
def execute_prompt_addin(
    ...
    *,
    ...
    try:
        resolved_system = system_prompt if system_prompt is not None else get_config(ctx, "extend_selection_system_prompt")
