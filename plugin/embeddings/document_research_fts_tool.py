...
class SearchNearbyFiles(ToolBase):
    ...
    def execute(self, ctx: ToolContext, **kwargs: Any) -> dict[str, Any]:
        ...
        def _run() -> dict[str, Any]:
            ...
            from plugin.embeddings.folder_fts_cache import fts_index_is_empty, resolve_fts_context
            from plugin.embeddings.folder_fts_indexer import ensure_fts_wakeup
