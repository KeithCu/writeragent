...
"""Wire-format → pandas DataFrame coercion for trusted analysis helpers.

Accepts Calc / payload_codec shapes (2D grid, records, {columns, rows}) and
applies Excel-like header + lightweight numeric parsing before analysis.
"""
